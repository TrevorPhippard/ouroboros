import { User } from "@/features/connections/schemas"
...
export const feedResolvers = {
  ...
  createPost: (variables: { content: string; author: User }) => {
    const newPost: PostType = {
      id: `p-${Math.random().toString(36)}`,
      author: {
        id: "variables.author.id",
        name: "variables.author.name",
        avatarUrl: "variables.author.avatarUrl",
        headline: "variables.author.headline",
      },
